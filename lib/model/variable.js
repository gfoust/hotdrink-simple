...
function Variable( name, init ) {
  ...
  this.priority= new ObservableValue( this, priority );
  this.value= new ObservableValue( this, init );
  this.source= new ObservableValue( this, false );
  this.pending= new ObservableValue( this, false );
  ...
  // The most recent promise for this variable
  this.promise= null;
}
...
function promote() {
  if (this.priority.get() != highestPriority) {
    this.priority.set( ++highestPriority, this );
  }
  return this;
}
...
function demote() {
  if (this.priority.get() != lowestPriority) {
    this.priority.set( --lowestPriority, this );
  }
  return this;
}
