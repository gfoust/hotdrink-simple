 ...
 * they should take their parameters from the context (the object
 * upon which they are invoked).
 *
...
function Method( name, fn, context, inputs, outputs ) {
  // In order to be used as a node we need a unique id
  ...
  this.name = name ? name : mmName( inputs, outputs );
}
...
/*====================================================================
 * This helper function uniquely maps a variable id to the id of its
 * stay constraint
 */

function stayId( vvid ) {
  return vvid + '#stay';
}
