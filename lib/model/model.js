...
m4_member(ModelPrototype, construct)
...
m4_member(ModelPrototype, variable)
...
m4_member(ModelPrototype, constraint)
function constraint() {
  var variables;
...
m4_member(ModelPrototype, computed)
function computed( name, inputs, fn ) {
  var vv= this.variable( name );
  inputs.push( vv );
  this.constraint( inputs )
    .method( [vv], fn );
  return vv;
}


m4_member(ModelPrototype, setRuntime)
...
m4_member(ModelPrototype, mapToVariable)
...
m4_member(ConstraintFactory, method)
function method( outputs, fn, context ) {
  ...
  var mm= new Method( outputs, fn, this.model, context );
