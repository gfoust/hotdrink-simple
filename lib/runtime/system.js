...
function update() {
  ...
  // Schedule
  this.schedule( changedMethods, changedVariables );
}
 ...
 */
m4_member(ConstraintSystem, schedule)
function schedule( changedMethods, changedVariables ) {
  LOG(SYS, 'schedule')
