...
m4_member(Constraint, getStrength)
function getStrength() {
  return Constraint.RequiredStrength;
}

function isInputVar( vv ) {
  return this.selectedMethod
    && this.selectedMethod.outputs.indexOf( vv ) === -1;
}

Object.defineProperty( Constraint.prototype, 'inputs',
                       {enumerable: true,
                        get: function() {
                          return this.variables.filter( isInputVar, this );
                        }}
                     );

Object.defineProperty( Constraint.prototype, 'outputs',
                       {enumerable: true,
                        get: function() {
                          return this.selectedMethod
...
function Method( outputs, fn, model, context ) {
...
m4_member(StayConstraint, getStrength)
function getStrength() {
